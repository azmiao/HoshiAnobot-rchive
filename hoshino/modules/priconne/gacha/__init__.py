...
JEWEL_EXCEED_NOTICE = f'您今天已经抽过{jewel_limit.max}钻了，腰包快空了鸭，还是明早5点后再来吧'
TENJO_EXCEED_NOTICE = f'您今天已经抽过{tenjo_limit.max}张天井券了，这样下去要吃不起饭啦，还是明早5点后再来吧'
SWITCH_POOL_TIP = '>发送"选择卡池"可切换'
POOL = ('MIX', 'JP', 'FES', 'TW', 'BL')
>>>>>>> custom modification
DEFAULT_POOL = POOL[0]
